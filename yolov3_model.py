...
class yolov3(object):
    ...
    def __init__(self, class_num, anchors, batch_norm_decay=0.999):
            ...
            with slim.arg_scope([slim.conv2d], normalizer_fn=slim.batch_norm,
                ...
                with tf.variable_scope('yolov3_head'):
                    ...
                    feature_map_1 = slim.conv2d(net, 3 * (5 + self.class_num), 1,
                                                ...
                                                activation_fn=None, weights_regularizer=slim.l2_regularizer(0.001),
    ...
    def predict(self, feature_maps):
        ...
        # compared to transpose -> boxes[0][1][2][3] -> stack is more understandable
    ...
    def compute_loss(self, y_pred, y_true):
        ...
        total_loss = loss_xy + loss_wh + loss_conf + loss_class + regularization_loss
        return [total_loss, loss_xy, loss_wh, loss_conf, loss_class, regularization_loss]
